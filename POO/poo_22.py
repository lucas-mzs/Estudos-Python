...
# ABCs são usados como contratos para a definição de novas classes. Elas podem forçar outras classes a criarem métodos concretos.
# Também podem ter métodos concretos por elas mesmas.
# @abstractmethod - são métodos que não têm corpo.
