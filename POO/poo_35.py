# Metaclasses são os tipo das classes.
...
# precisa (as pessoas que realmente precisam delas com certeza que precisam delas e não precisam de uma explicação sobre o porquê)."
